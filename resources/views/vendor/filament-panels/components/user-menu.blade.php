...
>
    <x-slot name="trigger">
        <button
            ...
            type="button"
        >
            <div class="flex items-center justify-center rounded-lg px-3 py-2 text-sm font-semibold outline-none transition duration-75 hover:bg-gray-50 focus:bg-gray-50 dark:hover:bg-white/5 dark:focus:bg-white/5 text-gray-700 dark:text-gray-200">
                {{ $user->name }}
